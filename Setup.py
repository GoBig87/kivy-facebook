...
osx_flags = {
    ...
    'depends': ['FacebookController.m', 'FacebookController.h']}

sources['facebook.pyx'] = merge(base_flags, osx_flags)
...
setup(
      ...
      keywords=['Facebook', 'Kivy'],
      author='GoBig87',
      author_email='finadmin@finaquaticrentals.com',
      url='https://github.com/GoBig87/Noke_Wrapper',
      license='BSD',
